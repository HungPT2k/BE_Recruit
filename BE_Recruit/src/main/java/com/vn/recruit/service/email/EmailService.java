package com.vn.recruit.service.email;
...
public class EmailService {
    ...
    public void sendEmail(String to, String email) {
        try {
            ...
            helper.setFrom("hung03hung@gmail.com");
    ...
    public String buildMailInterview(String jobName,String time,
        ...
        return "<p>Dear anh/chị "+userName+" <p><br>"
                +"<p>Công ty Vn rất vui và vinh hạnh khi nhận được hồ sơ ứng tuyển của anh/chị vào vị trí "
                ...
                +"<p>Thanks & best regards,</p><br><p>VN JSC</p><br><p>Head office: phường Dịch Vọng Hậu,quận Cầu Giấy, Hà Nội</p><br>"
